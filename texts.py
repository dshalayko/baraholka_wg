...
HAS_PHOTOS = "📸 У вас уже есть загруженные фото\n Хотите добавить новые или заменить текущие?"
...
PRICE_REQUEST_TEXT = "Принято! Теперь укажите цену."
ERROR_NO_ADS = "Ошибка: Не найдено ни одного объявления."
ERROR_ANNOUNCEMENT_NOT_FOUND_DB = "❌ Ошибка: объявление не найдено в базе."
DELETE_MANUALLY_MESSAGE = "Не удалось удалить сообщение боту:\nСсылка: {link}\nПожалуйста, удалите вручную."
ERROR_CANNOT_DETERMINE_ID = "❌ Ошибка: не удалось определить ID объявления."
EDIT_CHOICE_TEXT = "Что меняем?"
NOT_SUBSCRIBED_MESSAGE_SHORT = "Вы еще не подписаны на канал."
SUBSCRIPTION_PROMPT = "Пожалуйста, подпишитесь на наш канал, чтобы продолжить."
I_SUBSCRIBED_BUTTON = "Я подписался"
COMMENT_NOTIFICATION = "💬 Новый комментарий к вашему объявлению\n\n_{text}_\n\n🔗 [Посмотреть объявление]({link})"
MAIN_MENU_BUTTON = "В главное меню"
ADD_TO_OLD_PHOTOS = "➕ Добавить к старым"
REPLACE_ALL_PHOTOS = "🔄 Заменить все"
SKIP_ADD_PHOTOS = "🚫 Пропустить"
EDIT_BUTTON = "✏️ Редактировать"
PUBLISH_BUTTON = "📢 Опубликовать"
DELETE_BUTTON = "❌ Удалить"
EDIT_TEXT_BUTTON = "📝 Текст обьявления"
EDIT_PRICE_BUTTON = "💰 Цену"
EDIT_PHOTOS_BUTTON = "🖼️ Фотографии"
CANCEL_NOTHING_BUTTON = "🚫 Ничего не меняем"
EDIT_MESSAGE_TEXT_TEMPLATE = "Описание: {description}\nЦена: {price}\n\nОбновлено"
DRAFT_STATUS = "📝 _Черновик_\n"
PUBLISHED_STATUS = "[Опубликовано 📌]({})\n"
ERROR_CANNOT_GET_USER_DATA = "❌ Ошибка: не удалось получить данные пользователя."
