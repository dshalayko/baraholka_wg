...
START_NEW_AD = "Пришлите текст вашего объявления.\nДальше я попрошу указать цену и добавить фотографии. Но в первую очередь —расскажите, что вы хотите продать или купить. "
...
FULL_VERSION_MESSAGE = "➡️Ссылка на объявление"
