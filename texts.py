...
START_MINIAPP_MESSAGE = "Барахолка теперь не бот, а приложение. Откройте приложение через кнопку ниже"
...
OPEN_WEBAPP_BUTTON = "Открыть приложение"
...
# --- Даты ---
# Короткие названия месяцев в родительном падеже: "29 июл., 15:18".
# Ровно те же сокращения, что даёт Intl в мини-аппе ("мая" — полное слово, без точки).
MONTHS_SHORT = ("янв.", "февр.", "мар.", "апр.", "мая", "июн.", "июл.", "авг.", "сент.", "окт.", "нояб.", "дек.")
...
AUCTION_BUYOUT_PRICE = "Купить сразу"
